...
void GUI::Init(sf::Font * font, short textSize, int screenWidth, int screenHeight, bool* playAgain, bool* exit, bool* enterMenu)
{
	...
	m_frameTexture->loadFromFile("resources/frame.png");
	...
	m_returnToMenuButton = new Button(sf::Vector2f(screenWidth / 2 - 150, screenHeight / 2.3f - 50), sf::Vector2i(300, 75.f), "resources/pressButton.png", "resources/unpressButton.png", "Return to Menu");
	m_playAgainButton = new Button(sf::Vector2f(screenWidth / 2 - 150, screenHeight / 1.7f -50), sf::Vector2i(300, 75.f), "resources/pressButton.png", "resources/unpressButton.png", "Play Again");
	m_exitButton = new Button(sf::Vector2f(screenWidth / 2 - 150, screenHeight / 1.7f + screenHeight / 1.7f - screenHeight / 2.3f - 50), sf::Vector2i(300, 75.f), "resources/pressButton.png", "resources/unpressButton.png", "Exit Game");
