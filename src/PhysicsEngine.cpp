...
void PhysicsEngine::Update(float delta)
{
	for (unsigned int i = 0; i<m_players.size(); ++i)
	{
		...
		{
		case PhysicalBody::OnSingleTile: //single tile
		...
		case PhysicalBody::OnTwoTilesHorizontal: //On two tile horizontal
			...
			break;
		case PhysicalBody::OnTwoTilesVertical: //On two tile vertical
		...
		case PhysicalBody::OnFourTiles: //on four tiles
